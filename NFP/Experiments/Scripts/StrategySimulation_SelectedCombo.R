...
path_prediction = paste(paste("../Prediction/201412/SingleCombo/forwardSelection/DWin/Model",i,sep="_"),"unrevised_Predictions.csv",sep="_");
path_consensus = "../GroundTruth/Consensus.csv";
path_featureAR = "../Features/AR/ARDelta_Full.csv";

path_outDir = "../Simulation/201412/SingleCombo/forwardSelection/DWin";
