...
All_Features = read.csv(file='../Pulse/Company/IsVerified_True_MonthlyCounts.txt',sep='\t');
...
write.csv(Features_Full, file='../Pulse/Company/IsVerified_True_MonthlyCounts_candidate_separated.csv');