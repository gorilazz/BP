...
path_featureSocial = "../Features/201501/DaysBack_7_Features_All_candidate_seperated_AbsoluteFull_v1.csv";
...
path_outMetric = paste("../Model/201501/CV/V1/experiments_Combination_1",".csv",sep="");
